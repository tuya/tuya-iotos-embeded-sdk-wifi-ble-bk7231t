...
#define PS_CK_GPIO                 (0x0802800 +(6*4))
#define PS_UP_GPIO                 (0x0802800 +(16*4))
#define PS_RX_GPIO                 (0x0802800 +(17*4))
#define PS_BCN_GPIO                (0x0802800 +(7*4))
#define PS_DOWN_GPIO               (0x0802800 +(14*4))
#define PS_PWM_GPIO                (0x0802800 +(15*4))
